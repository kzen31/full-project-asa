                  ...
                  <tbody>
                    {complaints.map((object, i) =>
                      <tr key={i}>
                        ...
                        <td>{object.mess} No. {object.no_kamar}</td>
                        <td>{object.jenis_pakaian}</td>
                        <td>{object.jenis_deviasi}</td>
                        <td>{new Date(object.tanggal_laundry).toLocaleDateString()}</td>
...
export default connect(null, { setBreadcrumbItems })(TableLaundry);
